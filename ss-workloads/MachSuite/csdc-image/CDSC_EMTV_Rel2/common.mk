...
# Includes
INCLUDES  += -I. -I$(SRCDIR) -I$(CUDA_INSTALL_PATH)/include -I/Developer/gpu/shared/inc -I/Developer/gpu/C/common/inc
...
CXX_ARCH_FLAGS  :=
#NVCCFLAGS       := -keep
#NVCCFLAGS       := -Xcompiler "-O4 -ffast-math  -Wall -I. -DHAVE_MALLOC_H -DARCH_X86_64 -DSYS_LINUX DHAVE_PTHREAD -s -fomit-frame-pointer -DUNIX -ffloat-store  -fno-strict-aliasing"
NVCCFLAGS       := -Xcompiler "-O4 -Wall -I." -maxrregcount 20
LIB_ARCH        := $(OSARCH)
...
GENCODE_SM10 := -gencode=arch=compute_13,code=\"sm_13,compute_13\"
GENCODE_SM20 := -gencode=arch=compute_20,code=\"sm_20,compute_20\"

#CXXFLAGS  += $(CXXWARN_FLAGS) $(CXX_ARCH_FLAGS) -O4 -ffast-math -O3 -ffast-math  -Wall -I. -DHAVE_MALLOC_H -DARCH_X86_64 -DSYS_LINUX -DHAVE_PTHREAD -s -fomit-frame-pointer
CXXFLAGS  += $(CXXWARN_FLAGS) $(CXX_ARCH_FLAGS) -O4 -Wall -I. 
#CFLAGS      += #CFLAGS    += $(CWARN_FLAGS) $(CXX_ARCH_FLAGS) -O4 -ffast-math -O3 -ffast-math  -Wall -I. -DHAVE_MALLOC_H -DARCH_X86_64 -DSYS_LINUX -DHAVE_PTHREAD -s -fomit-frame-pointer
CFLAGS    += $(CWARN_FLAGS) $(CXX_ARCH_FLAGS) -O4 -Wall -I. 
#CFLAGS    += -Mcuda=maxregcount:16
LINKFLAGS +=
...
# Add common flags
NVCCFLAGS += $(COMMONFLAGS) --ptxas-options=-v
