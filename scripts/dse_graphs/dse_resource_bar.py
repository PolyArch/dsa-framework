...
def resource_area(filename, dse_folder):
    ...
    ax1.plot(times, normalized_total_lut, color='blue', label='Total Lut')
    ax1.plot(times, normalized_logic_lut, color='green', label='Logic Lut')
    ax1.plot(times, normalized_ram_lut, color='red', label='Ram Lut')
    ax1.plot(times, normalized_srl, color='purple', label='SRL')
    ax1.plot(times, normalized_ff, color='orange', label='Flip Flop')
    ax1.plot(times, normalized_ramb36, color='purple', label='Ramb36')
    ax1.plot(times, normalized_ramb18, color='cyan', label='Ramb18')
    ax1.plot(times, normalized_uram, color='yellow', label='Uram')
    ax1.plot(times, normalized_dsp, color='lime', label='DSP')
    ...
    ax1.plot(times, scaled_normalized_total_lut, color='blue', label='Total Lut')
    ax1.plot(times, scaled_normalized_logic_lut, color='green', label='Logic Lut')
    ax1.plot(times, scaled_normalized_ram_lut, color='red', label='Ram Lut')
    ax1.plot(times, scaled_normalized_srl, color='purple', label='SRL')
    ax1.plot(times, scaled_normalized_ff, color='orange', label='Flip Flop')
    ax1.plot(times, scaled_normalized_ramb36, color='purple', label='Ramb36')
    ax1.plot(times, scaled_normalized_ramb18, color='cyan', label='Ramb18')
    ax1.plot(times, scaled_normalized_uram, color='yellow', label='Uram')
    ax1.plot(times, scaled_normalized_dsp, color='lime', label='DSP')
    ...
    fig, ax1 = plt.subplots(1, 1)
    fig.set_size_inches(16, 12)
    ax1.plot(times, overall_util, color='blue', label='Overall Utilization')
    ax1.plot(times, link_util, color='green', label='Link Utilization')
    ax1.plot(times, node_util, color='red', label='Node Utilization')
    ax1.set_ylim(ymin=0)
    ax1.set_xlim(xmin=0)
    ax1.set_xlabel('Time (s)')
